...
public class Section
{
    ...
    public void drawSection(MatrixStack poseStack, float r, float g, float b)
    {
        drawSection(poseStack, r, g, b, 255);
    }

    public void drawSection(MatrixStack poseStack, float r, float g, float b, float a)
    {
        ...
        AbstractGui.fill(poseStack, x, y, right, down, color);
    }
